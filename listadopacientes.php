...
$consulta = $mysql->efectuarConsulta("SELECT agendacitas.pacientes.id_paciente, agendacitas.pacientes.nombre, 
								agendacitas.pacientes.apellidos,agendacitas.pacientes.num_documento,
								agendacitas.pacientes.genero,agendacitas.pacientes.email,agendacitas.pacientes.telefono,
								agendacitas.pacientes.medicamentos,agenda.pacientes.alergias
