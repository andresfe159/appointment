...
<html lang="es">
                                ...
                                <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
                                    ...
                                    <div class="collapse" id="pagesCollapseError" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordionPages">
                                        <nav class="sb-sidenav-menu-nested nav">
                                            ...
                                            <a class="nav-link" href="insertarpaciente.php">Registrar Paciente</a>
                                        </nav>
                                        </div>
                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Autenticacion</li>
    ...
    <input class="controls" type="text" name="nombres" id="nombres" placeholder="Ingrese nombres" required="">
    <input class="controls" type="text" name="apellidos" id="apellidos" placeholder="Ingrese apellidos" required="">
...
<!--<select class="especialidad" name="especialidad" id="especialidad">
    ...
    <input class="controls" type="email" name="correo" id="correo" placeholder="Ingrese correo electrónico"required="">
    <input class="controls" type="text" name="username" id="username" placeholder="Ingrese username" required="">
