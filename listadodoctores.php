...
$consulta = $mysql->efectuarConsulta("SELECT agendacitas.doctores.nombre, 
								agendacitas.doctores.apellidos, agendacitas.doctores.num_documento, agendacitas.doctores.especialidad,
								agendacitas.doctores.genero,agendacitas.doctores.email,agendacitas.doctores.telefono,
								FROM agendacitas.doctores");
