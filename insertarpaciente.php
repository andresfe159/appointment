...
<html lang="es">
            ...
            <ul class="navbar-nav ms-auto me-0 me-md-3 my-2 my-md-0">
                <li class="nav-item dropdown">
                    ...
                    <li><a class="dropdown-item" href="#">Perfil</a></li>
                        ...
                        <li><a class="dropdown-item" href="LOGIN/login.html">Cerrar Sesion</a></li>
                    </ul>
                </li>
            </ul>
        </nav>
        ...
        <div id="layoutSidenav">
                                ...
                                <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
                                    ...
                                    <div class="collapse" id="pagesCollapseError" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordionPages">
                                        <nav class="sb-sidenav-menu-nested nav">
                                            ...
                                            <a class="nav-link" href="insertardoctor.php">Registrar Doctor</a>
                                        </nav>
                                    </div>
            ...
            <!--CONTENIDO-->
                <main>
                                ...
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>2011/04/25</td>
                                            <td>$320,800</td>
                                            <td><input type="button" class="btn btn-primary" value="Editar"></a></td>
                  ...
                  <!-- <form action="controlador/creardoctor.php" method="POST"> 
    ...
    <form method="POST" action="../controlador/crearpaciente.php">
    ...
    <input class="controls" type="text" name="ID" id="documento" placeholder="Ingrese su número de documento" required="">
    ...
    <!--<input class="controls" type="text" name="genero" id="genero" placeholder="Ingrese su genero (M  O F)"required="">-->
    <input class="controls" type="email" name="correo" id="correo" placeholder="Ingrese su correo electrónico"required="">
    <input class="controls" type="number" name="telefono" id="telefono" placeholder="Ingrese su numero de telefono" required="">
    <input class="controls" type="text" name="enfermedades" id="enfermedades" placeholder="Enfermedades" required="">
    <input class="controls" type="text" name="medicamentos" id="medicamentos" placeholder="Medicamentos" required="">
    
    <select class="especialidad" name="alergias" id="alergias">
