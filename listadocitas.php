...
$consulta = $mysql->efectuarConsulta("SELECT agendacitas.citas.titulo, 
								agendacitas.pacientes.nombre, agendacitas.doctores.nombre, agendacitas.citas.notas,
                                agendacitas.citas.fehca_cita,agendacitas.citas.hora_cita,agendacitas.citas.sintomas,
                                agendacitas.citas.costo,    
...
<td><?php echo $row['tipo_usuario_id_FK'] ?></td>
